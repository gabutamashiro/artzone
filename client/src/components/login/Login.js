  ...
  return (
    <div className="login__container">
      <div className="login__welcome">
        ...
        <img src={logo} alt="ArtZone"/>
        </div>
        <p>Crie suas artes e compartilhe-as com o mundo!</p>
      </div>
      <div className="login__form-container">
        <div className="login__form">
          ...
          <span className="login__forgot-password">Esqueceu sua senha?</span>
          <span className="login__signup" onClick={() => toggleModal(true)}>Crie sua nova conta</span>
        </div>
      </div>
    </div>
  );
